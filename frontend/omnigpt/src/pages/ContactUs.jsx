      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            Reach out to us at OmniGPT for any inquiries or assistance. Our team is here to provide you with the best support possible. Whether you have questions or need help, we are ready to assist. Contact us and experience our exceptional service.
            </p>
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
              <div className="flex gap-x-4">
                ...
                <dd>
                  108,2495 Maynard Street,
                  <br />
                  Halifax,NS B3K 3V2,Canada
                </dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd>
                  <a href="tel:+1 (782) 882-7332" className="hover:text-white">
                    +1 (782) 882-7332
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:omnigpt@gmail.com" className="hover:text-white">
                    omnigpt@gmail.com
                  </a>
                </dd>
              </div>
